...
export default function Navigation() {
	...
	useEffect(()=>{
		currentSiderList && currentSiderList[0]?.children && currentSiderList[0]?.children[0]?.name && setActive(currentSiderList[0].children[0].name)
	},[location.pathname, currentSiderList])
