...
interface SettingFilterProps {
	handleCreateAssitans: () => void
}

const SettingFilter: FC<SettingFilterProps> = (props) => {
	const { handleCreateAssitans } = props
	
	const handleClickAddCircle = () => {
		handleCreateAssitans()
	}
	...
	return (
		<SidePane>
			...
			>
				...
				<Button startDecorator={<AddCircle />} size="sm" onClick={handleClickAddCircle}>
                增加新的
				</Button>
			</Box>
			<Box
